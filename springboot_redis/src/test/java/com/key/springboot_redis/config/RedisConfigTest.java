package com.key.springboot_redis.config;

import com.key.springboot_redis.domain.UserVo;
import com.key.springboot_redis.service.RedisService;
import com.key.springboot_redis.util.RedisKeyUtil;
...
//        redisService.expireKey("name", 200, TimeUnit.SECONDS);
